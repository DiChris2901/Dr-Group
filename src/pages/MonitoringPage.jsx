...
const MonitoringPage = () => {
  ...
  // El hook useCommitmentAlerts necesita commitments como parámetro, lo omitiremos por ahora
  ...
  const [activeAlerts, setActiveAlerts] = useState([
    {
      ...
      message: 'ABC Corp tiene un pago vencido de $5,000',
      severity: 'error',
    ...
    },
    {
      id: 2,
      title: 'Pago Próximo',
      message: 'XYZ Industries - Vencimiento en 2 días',
      severity: 'warning',
    ...
    },
    {
      ...
      message: 'Tech Solutions ha completado su compromiso mensual',
      severity: 'success',
  ...
  const [recentActivity] = useState([
    ...
    },
    {
      id: 2,
      type: 'commitment',
      description: 'Nuevo compromiso creado',
      status: 'active',
    ...
    },
    {
      id: 3,
      type: 'company',
      description: 'Empresa XYZ actualizada',
      status: 'updated',
      timestamp: 'Hace 1 hora'
    }
  ]);
