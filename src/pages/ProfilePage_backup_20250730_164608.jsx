                      ...
                      >
                        <Typography variant="h6" fontWeight="bold" color="primary.main">
                          {user?.metadata?.creationTime ? 
                            Math.floor((new Date() - new Date(user.metadata.creationTime)) / (1000 * 60 * 60 * 24)) : 0
                          }
                        </Typography>
                        <Typography variant="caption" color="text.secondary">
                          Días activo
                      ...
                      <Box 
                        ...
                        sx={{
                          ...
                          background: user?.emailVerified 
                            ...
                            : (isDarkMode ? 'rgba(255, 152, 0, 0.1)' : 'rgba(255, 152, 0, 0.05)'),
                          border: `1px solid ${user?.emailVerified ? 'rgba(76, 175, 80, 0.2)' : 'rgba(255, 152, 0, 0.2)'}`
                        }}
                      >
                        <Typography 
                          variant="caption" 
                  ...
                  <Grid item xs={12}>
                    ...
                    >
                      <Box sx={{ position: 'relative' }}>
                        ...
                        >
                          <Edit sx={{ fontSize: 18, color: '#a29bfe' }} />
                          Biografía
                        </Typography>
                        <TextField
                          fullWidth
                          ...
                          sx={{
                            '& .MuiOutlinedInput-root': {
                              backgroundColor: editing 
                                ? (isDarkMode ? 'rgba(162, 155, 254, 0.15)' : 'rgba(162, 155, 254, 0.08)')
                                : (isDarkMode ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.06)'),
                              border: editing 
                                ? '2px solid rgba(162, 155, 254, 0.3)'
                                : '2px solid rgba(0, 0, 0, 0.1)',
                              borderRadius: 3,
                              transition: 'all 0.3s ease',
                              '&:hover': editing ? {
                                backgroundColor: isDarkMode ? 'rgba(162, 155, 254, 0.2)' : 'rgba(162, 155, 254, 0.12)',
                                borderColor: 'rgba(162, 155, 254, 0.5)',
                                transform: 'translateY(-1px)',
                                boxShadow: '0 4px 12px rgba(162, 155, 254, 0.2)'
                              } : {},
                              '&.Mui-focused': {
                                backgroundColor: isDarkMode ? 'rgba(162, 155, 254, 0.25)' : 'rgba(162, 155, 254, 0.15)',
                                borderColor: '#a29bfe',
                                boxShadow: '0 0 0 3px rgba(162, 155, 254, 0.15)'
                              },
                              '& fieldset': {
                                border: 'none'
                              }
