          ...
          getDoc(doc(db, 'users', senderId))
            .then(userDoc => {
              ...
              if (userDoc.exists()) {
                ...
                // Fallback al nombre cacheado si no existe el usuario
              ...
              // Guardar en localStorage después de procesar
              saveNotifiedMessages();
            })
            .catch(err => {
              console.warn('Error obteniendo nombre del remitente:', err);
              // Fallback: usar nombre cacheado y procesar notificación de todos modos
