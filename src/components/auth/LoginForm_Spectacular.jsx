    ...
    <Box
      sx={{
        ...
        '&::before': {
          ...
          bottom: 0,
          background: theme.palette.mode === 'dark'
            ? 'radial-gradient(circle at 30% 20%, rgba(102, 126, 234, 0.08) 0%, transparent 50%), radial-gradient(circle at 70% 80%, rgba(118, 75, 162, 0.06) 0%, transparent 50%)'
                      ...
                      <Box 
                        sx={{ 
                          ...
                          '&::before': {
                            ...
                            right: 0,
                            bottom: 0,
                            background: `linear-gradient(135deg, ${theme.palette.primary.main}08 0%, transparent 50%, ${theme.palette.secondary.main}08 100%)`,
                            zIndex: 1
                          }
                        }}
                      >
