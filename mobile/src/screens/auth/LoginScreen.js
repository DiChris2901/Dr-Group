...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // ? Preguntar si desea guardar credenciales para biometr�a
      if (isBiometricSupported) {
        Alert.alert(
          'Habilitar Biometr�a',
          '�Deseas usar tu huella/rostro para iniciar sesi�n la pr�xima vez?',
          [
            ...
            { 
              ...
              onPress: async () => {
                ...
                Alert.alert('�xito', 'Biometr�a habilitada');
              }
            }
          ]
        );
          ...
          >
            ...
            >
              <Text variant="bodySmall" style={{ color: theme.colors.onSecondaryContainer, textAlign: 'center', lineHeight: 18 }}>
                ?? Al iniciar se registra tu hora y ubicaci�n (para identificar trabajo remoto u oficina) para control de asistencias
              </Text>
            </Surface>
