 ...
 * Utiliza HTML/CSS para crear PDF profesional con branding Organizaci�n RDJ
 */
...
<body>
  <div class="container">
    ...
    <div class="header">
      ...
      <p>${month} ${year} - Organizaci�n RDJ</p>
    </div>
    ...
    <!-- Footer -->
    <div class="footer">
      <p>Generado automáticamente por <strong>RDJ Asistencia App</strong></p>
